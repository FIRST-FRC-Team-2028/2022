...
//  */
// public class TurretOLD extends SubsystemBase {
...
//   public TurretOLD(RobotContainer robotContainer) {
...
//   private boolean limitOverride = true;
...
//         if(!limitOverride && turretencoder.getPosition() > turretupperlimit ) {
//           turretMotor.set(Math.min(0., turretMotor.get()));
//         } 
    
//         if(!limitOverride && turretencoder.getPosition() < turretlowerlimit ) {
